<nav x-data="{ open: false }" class="bg-white  bg-gray-800 border-b border-gray-100  border-gray-700">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    ...
                    <img src="{{ asset('images/custom-logo.webp') }}" alt="App Logo" class="h-9 w-auto">
                    </a>
                </div>
    ...
    @endif
            ...
            @if (Auth::user()->avatar)
    <img class="h-6 w-6 rounded-full object-cover" src="{{ asset('storage/' . Auth::user()->avatar) }}" alt="User Avatar">
@else
    <img class="h-6 w-6 rounded-full object-cover" src="{{ asset('images/user-avatar.jfif') }}" alt="Default Avatar">
@endif
